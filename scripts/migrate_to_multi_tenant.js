...
// ==========================================
let appCode = fs.readFileSync(path.join(__dirname, '..', 'js', 'app.js.restored'), 'utf8');
...
// E. Add Dynamic Customizer getModifiersForItem and update openModifierModal
...
// ==========================================
let adminCode = fs.readFileSync(path.join(__dirname, '..', 'js', 'admin.js.restored'), 'utf8');
